...
2. 一阶全微分的形式不变性
    ...
    $$
    \begin{aligned}
    \mathrm dz&=\dfrac{\partial z}{\partial x}\mathrm dx+\dfrac{\partial z}{\partial y}\mathrm dy\\&=\dfrac{\partial z}{\partial u}\mathrm du+\dfrac{\partial z}{\partial u}\mathrm du
    \end{aligned}
    $$
